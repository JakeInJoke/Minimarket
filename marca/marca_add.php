...
if (isset($_POST['add'])) {
    ...
    $statement->bind_param("iss", $cod_marca, $nombre_marca, $imagen_marca);
...
<html>
    ...
    if (isset($_SESSION['rol_numero']) && $_SESSION['rol_numero'] == 10) {
        ...
        <body>
            ...
            ?>
            <h2 style="margin-top: 50px; padding-left: 250px;"> AGREGAR NUEVA MARCA </h2>
            <br><hr><br>
